...
public class Obra {
	...
	public String toString() {
		...
		cs.append("\nT�tulo: " + this.getTitulo() + " | Pre�o: "  +  fc.format(this.getPreco()) + " | Cria��o: " + formato.format(this.getDataCriacao()) 
		+ "\nSitua��o: " + this.getSituacao() + " | Tipo: " + this.getTipo() + " | Material: " + this.getMaterial() 
