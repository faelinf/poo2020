...
public class ClasseTestaAgenda {
	public static void main(String[] args) {
		...
		System.out.println("\nOpoes:\n(1)Imprimir Agenda\n"
				+ "(2)Consultar informacoes da Pessoa\n(3)Quero saber a posicao do contato\n(4)Remover pessoa\n(5)Sair");
		...
		do {
			...
			case 2: System.out.println("Digite a posicao do contato que deseja consultar?");
			...
			case 3: System.out.println("Digite o nome que deseja consultar");
			String nome = sc.nextLine();
			int pos = c.buscaContato(nome);
			if(pos != 0)
			System.out.println("\nA posicao de " + nome + " e: " + pos);
			else
				System.out.println("\nO nome nao esta na lista");
			break;
			
			case 4: System.out.println("Qual contato deseja remover?");
				c.removeContato(sc.nextLine());
			break;
			case 5: break;
			}
			System.out.println("\nOpcoes:\n(1)Imprimir Agenda\n"
					+ "(2)Consultar informacoes da Pessoa\n(3)Quero saber a posicoeo do contato\n(4)Remover pessoa\n(5)Sair");
					option = sc.nextInt();
					sc.nextLine();
