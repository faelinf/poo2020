...
public class Arvore {
	...
	public static void main(String[] args) {
		...
		System.out.println("Digite o nome da av� ?");
		fm.vo = sc.nextLine();
		
		System.out.println("Digite o nome da av� ?");
		fm.vo1 = sc.nextLine();
		
		System.out.println("Digite se Tem filhos ?");
		mb = sc.next();
		...
		if(mb.equals("sim")) {
			...
			num = sc.nextInt();
			sc.nextLine();
			System.out.println("Digite Quais os nomes ?");
		...
		if(mb.equals("n�o")){
			System.out.println("Nome : " + fm.nome + ", idade: " + fm.idade);
			System.out.println("Avos : " + fm.vo + ", " + fm.vo1);
			System.out.println("Pais : " + fm.mae + ", " + fm.pai);
